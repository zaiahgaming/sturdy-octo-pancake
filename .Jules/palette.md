...
## 2024-05-15 - Screen Reader Spam on Timers
...
**Action:** Use `aria-hidden="true"` on the frequently updating container and announce meaningful state changes using a visually hidden, dedicated `aria-live` region.
