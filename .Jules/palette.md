...
## 2024-05-20 - Accessible Countdown Timers
**Learning:** Placing aria-live="polite" on frequently updating UI elements like countdown timers causes screen reader spam.
**Action:** Replaced aria-live on the updating timer container with aria-hidden, and introduced a visually hidden aria-live region to announce only meaningful state changes (acquired, expired, destroyed).
